...
export async function activate(context: vscode.ExtensionContext) {
    ...
    const registerCommand = <T extends unknown[]>(command: string, callback: (...args: T) => unknown) => {
    ...
    registerCommand('pin-context.toggleViewMode', async () => {
        ...
        vscode.window.showInformationMessage(`Pinned Files view mode: ${newMode === 'tree' ? 'Tree' : 'List'}`);
